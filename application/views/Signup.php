        ...
        <div class="top">
          ...
          <div class="form">
            <div class="input_field">
              <input type="text" placeholder="Enter your name" name="firstname" class="input">
              <small class="text-danger"><?php echo form_error('firstname'); ?></small>
            </div>
            <div class="input_field">
              <input type="text" placeholder="Enter your surname" name="lastname" class="input">
            ...
            <div class="input_field">
              <input type="password" placeholder="Provide a password" name="password" class="input">
              <small class="text-danger"><?php echo form_error('password'); ?></small>
            </div>
            <div class="btn"><button type="submit" name="submit">Signup</button></div>
          </div>
          <div class="or">
            <div class="line"></div>
            <p>OR</p>
