		...
		<div class="top">
			...
			<div class="form">
				<div class="input_field">
					<input type="text" placeholder="Enter the product name" name="prodname" value="<?= $product->product_Name ?>" class="input">
                    <small class="text-danger"><?php echo form_error('prodname'); ?></small>
				</div>
				<div class="input_field">
					<input type="text" placeholder="Enter the product brand" name="brand" value="<?= $product->brand ?>" class="input">
                    <small class="text-danger"><?php echo form_error('brand'); ?></small>
				</div>
                <div class="input_field">
					<input type="text" placeholder="Enter the supplier phone" name="sphone" value="<?= $product->supplier_phone ?>" class="input">
                    <small class="text-danger"><?php echo form_error('sphone'); ?></small>
				</div>
                <div class="input_field">
					<input type="text" placeholder="Enter the supplier" name="supplier" value="<?= $product->supplier ?>" class="input">
